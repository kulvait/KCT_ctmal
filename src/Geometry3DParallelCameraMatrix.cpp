...
namespace geometry {
    ...
    {
        std::copy(vector9, vector9 + 9, std::begin(this->projectionMatrixVector));
    }
    ...
    Geometry3DParallelCameraMatrix::Geometry3DParallelCameraMatrix(const uint32_t anglesCount,
    ...
    void Geometry3DParallelCameraMatrix::backprojectToPosition(const double pi,
                                                               const double pj,
                                                               double* vector3) const;
    std::array<double, 3>
    Geometry3DParallelCameraMatrix::backprojectToPosition(const double pi, const double pj) const;
    ...
    std::string Geometry3DParallelCameraMatrix::toString(std::string name = "P") const;
